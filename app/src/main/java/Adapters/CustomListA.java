...
public class CustomListA extends ArrayAdapter<String> {
    ...
    public CustomListA(Context context, ArrayList<String> object,ArrayList<String>State, String series, String section, String course, String cycle) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (State.get(position).equals("true")) {
                    checkBox1.setChecked(true);
                  day.updateState(course, series, section, cycle, "A", object.get(position), "false");
                    StateUpdate();
                } else {
                    checkBox1.setChecked(false);
                    day.updateState(course, series, section, cycle, "A", object.get(position), "true");
                    StateUpdate();
                }
    ...
    public void StateUpdate() {
        State=day.getState(series,section,course,cycle,"A");
    }
}
