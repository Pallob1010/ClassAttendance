...
public class CustomListB extends ArrayAdapter<String> {
    ...
    Context mContext;
    DatabaseBday databaseAday;
    String series, section, course, cycle;

    public CustomListB(Context mContext, ArrayList<String> object, ArrayList<String>State, DatabaseBday aday, String series, String section, String course, String cycle) {
        super(mContext, R.layout.singlerecycler, object);
        databaseAday = new DatabaseBday(mContext);
        this.object = object;
        this.series = series;
