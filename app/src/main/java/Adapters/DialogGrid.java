...
public class DialogGrid extends BaseAdapter{
    private Context mContext;
    private ArrayList<Restore>object;

    public DialogGrid(Context c,ArrayList<Restore>object) {
        mContext = c;
        this.object=object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.CourseCode.setText(object.get(position).getCourse());
