...
public class DatabaseAday extends SQLiteOpenHelper {
    ...
    public Cursor GetStateAday(String course,String series,String section,String cycle,String day){
        SQLiteDatabase db=this.getWritableDatabase();
    ...
    public Cursor GetRollStateAday(String course,String series,String section,String cycle){
        SQLiteDatabase db=this.getWritableDatabase();

        String SQL="SELECT State,Roll FROM "+TableName+" WHERE Course = "+"'"+course+"'"+" AND Series = "+"'"+series+"'"+" AND Section = "+"'"+section+"'" +" AND Cycle = "+"'"+cycle+"'" +" AND Day = "+"'"+"A"+"'" ;
        Cursor cursor=db.rawQuery(SQL,null);
        return cursor;
    ...
    public Cursor GetStateExtra(String course,String series,String section,String cycle,String roll){
        ...
        String SQL="SELECT State FROM "+TableName+" WHERE Course = "+"'"+course+"'"+" AND Series = "+"'"+series+"'"+" AND Section = "+"'"+section+"'" +" AND Cycle = "+"'"+cycle+"'" +" AND Day = "+"'"+"A"+"'"+" AND Roll="+"'"+roll+"'";
        Cursor cursor=db.rawQuery(SQL,null);
        return cursor;
    ...
    public Cursor GetRoll(String course,String section,String cycle,String series){
        SQLiteDatabase db=this.getWritableDatabase();
