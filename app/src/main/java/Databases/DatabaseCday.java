...
public class DatabaseCday extends SQLiteOpenHelper {
    ...
    public int  insertRollStateCDay(String course,String series,String section,String cycle,String day,String roll,String state){
    ...
    public void UpdateStateCday(String course,String series,String section,String cycle,String day,String roll,String state){
    ...
    public Cursor GetStateCday(String course,String series,String section,String cycle,String day){
        SQLiteDatabase db=this.getWritableDatabase();
    ...
    public Cursor GetRollStateCday(String course,String series,String section,String cycle){
        SQLiteDatabase db=this.getWritableDatabase();

        String SQL="SELECT State FROM "+TableName+" WHERE Course = "+"'"+course+"'"+" AND Series = "+"'"+series+"'"+" AND Section = "+"'"+section+"'" +" AND Cycle = "+"'"+cycle+"'" +" AND Day = "+"'"+"C"+"'" ;
        Cursor cursor=db.rawQuery(SQL,null);
        return cursor;
    ...
    public Cursor GetStateExtra(String course,String series,String section,String cycle,String roll){
        ...
        String SQL="SELECT State FROM "+TableName+" WHERE Course = "+"'"+course+"'"+" AND Series = "+"'"+series+"'"+" AND Section = "+"'"+section+"'" +" AND Cycle = "+"'"+cycle+"'" +" AND Day = "+"'"+"C"+"'"+" AND Roll="+"'"+roll+"'";
        Cursor cursor=db.rawQuery(SQL,null);
        return cursor;
